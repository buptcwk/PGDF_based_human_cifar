...
def parse_args(file):
    ...
    parser.add_argument('--noise_type', required=True,type = str, help='aggre, worst, rand1, noisy100', default='worst')
    ...
    args.noise_type = cmdline_args.noise_type
    ...
    args.checkpoint_path += "/" + "/".join(args.preset.split(".")) + "/" + args.noise_type

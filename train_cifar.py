...
if __name__ == "__main__":
    ...
    while epoch < args.num_epochs:
        ...
        noise_type_name = noise_type_map[args.noise_type]
        if args.num_class == 10:
            test_model = f"./cifar10_{noise_type_name}best.pth.tar"
        elif args.num_class == 100:
            test_model = f"./cifar100_{noise_type_name}best.pth.tar"
        torch.save(data_dict, test_model)
        epoch += 1
